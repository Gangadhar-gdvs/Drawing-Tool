...
const Canvas = ({ settings, ...rest }) => {
  ...
  const shareDrawingData = () => {
    ...
    link.download = `drawing_data_${Date.now()}.json`;
    link.click();
  ...
  return (
    <>
      ...
      <div className="navbar-brand">
        <span className="navbar-logo">My Drawing Tool</span>
      </div>
      </nav>
      <canvas
        ref={canvas}
      ...
      >
        ...
        className="button" 
        type="button" 
        onClick={shareDrawingAsImage}
        disabled={history.current.length === 0}
        >
            <img className="img-right" src="assets/png_file.png" alt="Share as Img" title="Share as Image" />
        </button>
       <button 
       className="button" 
       type="button" 
       onClick={shareDrawingData}
       disabled={history.current.length === 0}
       >
           <img className="img-right" src="assets/json.png" alt="Share Drawing Data" title="Share Drawing Data" />
        </button>
